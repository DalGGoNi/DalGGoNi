...
//var oPopup = window.open(modal=yes);
...
function Show_cal(sYear, sMonth, sDay) {
  ...
  // SELECT 년도 설정
  for (var optYear=(intThisYear-50); optYear<(intThisYear+50); optYear++) {
  ...
  var calHeight = oPopBody.document.getElementById('Cal_Table').offsetHeight;
  //행이 6개 행인지, 5개인지 구분
